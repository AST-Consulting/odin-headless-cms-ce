...
// SoundCloud icon component - using official SoundCloud tile logo
...
export function getSoundCloudSlashCommand(
    handleSoundCloudEmbed: () => void
): DefaultReactSuggestionItem {
    return {
        title: "SoundCloud",
        onItemClick: handleSoundCloudEmbed,
        aliases: ["soundcloud", "audio", "music", "sound"],
        group: "Embeds",
        icon: React.createElement(SoundCloudIcon),
        subtext: "Embed a SoundCloud track",
    };
}
