...
export class QuerySlugDto extends PartialType(PaginationQueryDto) {
  @ApiPropertyOptional({
    name: 'id',
  ...
  @ApiPropertyOptional({
    name: 'Status',
    description: 'Status of the slug',
